...
export function InventoryPage() {
  ...
  return (
    <div className="h-[calc(100vh-2rem)] w-full bg-[var(--color-cream)] p-6 overflow-hidden relative">
      ...
      {tab === 'pantry' && (
        <>
          ...
          />
          <div className="absolute inset-0 bg-[var(--color-cream)]/25 pointer-events-none" />
        </>
      )}
      <div className="relative h-full max-w-5xl mx-auto flex flex-col gap-5">
        ...
        {/* Scanner */}
        {showScanner && (
          <div className="rounded-2xl border border-[var(--color-line)] bg-[var(--color-cream)]/60 p-5 shrink-0">
            <BarcodeScanner
              onDetected={(code) => {
