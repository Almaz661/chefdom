      ...
      <GlassCard className="p-10 text-center">
        ...
        {tab === 'freezer' && (
          <p className="text-white/25 text-xs mt-3">
            ...
            <Link to="/preserves" className="text-[var(--cd-gold)] hover:underline">
              Заготовки
            </Link>
        ...
        <section key={cat}>
          <div className="flex items-center gap-2 mb-2.5">
            ...
            {cat === 'Заготовки' && (
              <Link
                to="/preserves"
                className="ml-auto text-[11px] text-[var(--cd-gold)]/60 hover:text-[var(--cd-gold)] normal-case font-normal tracking-normal transition-colors"
              >
                в раздел →
              </Link>
            )}
