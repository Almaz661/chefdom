        ...
        <GlassCard className="relative w-full sm:w-[400px] sm:max-w-[95vw] p-7 rounded-t-[24px] sm:rounded-[24px]">
          ...
          {isLoading && (
            <div className="flex items-center justify-center py-10">
              <Loader2 size={28} className="animate-spin text-[var(--cd-gold)]" />
          ...
          {product && !isLoading && (
            <>
              ...
              <fieldset className="mb-4">
                ...
                <div className="flex gap-1 p-1 rounded-xl border border-[var(--cd-line)] bg-white/[0.03]">
                  {STORAGE_OPTIONS.map(({ key, label }) => (
                    <button
                      ...
                      className={`flex-1 px-2 py-2.5 rounded-lg text-xs font-semibold transition-all duration-200 ${
                        storageType === key
                          ? 'bg-[var(--cd-gold)]/20 text-[var(--cd-gold)] border border-[var(--cd-gold)]/30'
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-3">
                  ...
                  <input
                    ...
                    placeholder="Ед."
                    className="w-24 h-12 px-4 bg-white/[0.04] border border-[var(--cd-line)] rounded-xl text-white placeholder-white/25 focus:outline-none focus:border-[var(--cd-gold)]/50 transition-colors"
                  />
                </div>
                <div>
                  <input
