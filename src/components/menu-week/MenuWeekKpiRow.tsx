  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      {KPI_DATA.map(({ icon: Icon, value, label, accent }) => (
        <div
          key={label}
          className="bg-white/[0.03] border border-[var(--cd-line)] rounded-xl p-4 flex items-center gap-4 hover:border-white/[0.10] hover:bg-white/[0.05] transition-all duration-200"
        >
          <div
