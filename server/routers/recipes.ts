...
- Если шаги не написаны явно — извлеки их из субтитров или описания (опиши процесс своими словами на основе текста)
- ВСЕГДА старайся извлечь рецепт, даже если информация неполная. Лучше неточный рецепт чем отказ.
- Верни {"error": "причина"} ТОЛЬКО если в тексте вообще нет никакой информации о еде/готовке
