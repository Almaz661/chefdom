...
const migrations: Migration[] = [
  ...
  },
  {
    ...
    up: async (sql) => {
      ...
      `;
      await sql`
        CREATE INDEX IF NOT EXISTS idx_ingredients_name_ru
        ON ingredients(name_ru)
      `;
      await sql`
      ...
      `;
      await sql`
        CREATE INDEX IF NOT EXISTS idx_products_name_ru
        ON products(name_ru)
      `;
      ...
      `;
      await sql`
        CREATE INDEX IF NOT EXISTS idx_substitutions_ingredient
        ON ingredient_substitutions(ingredient_name)
      `;
    },
  },
];
