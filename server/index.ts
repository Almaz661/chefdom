...
// Запрет HTTP-кеширования для tRPC запросов.
// Без этого браузер кеширует GET-запросы (queries) по URL и не отправляет
// их на сервер повторно — пользователь видит устаревшие данные.
